...
Application::Application(int wid, int hei){
    ...
    m_texture = SDL_CreateTexture(m_renderer, SDL_PIXELFORMAT_ABGR8888, SDL_TEXTUREACCESS_STREAMING, Application::width, Application::height);
...
void Application::loop(){
    ...
    while(keep_window_open){
        ...
        // SDL_RenderClear(m_renderer);
        clearscr();
        m_player.cameraRender(m_map, m_renderer, m_texture, Application::width, Application::height);
